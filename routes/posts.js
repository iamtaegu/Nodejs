...
router.get('/:id', function(req, res){
  ...
  Promise.all([
    ...
    .then(([post, comments]) => {
      var commentTree = util.convertToTrees(comments, '_id','parentComment','childComments');
      res.render('posts/show', { post:post, commentTrees:commentTree, commentForm:commentForm, commentError:commentError});
    })
    .catch((err) => {
      return res.json(err);
    });
